...
let users = [
  // { id: 1, name: "Angela", color: "teal" } - user object structure
];
let error = ""; //declare error variable
//create a users table in postgres
//delete existing visited_countries table and create a new one with many to many relationship as follows:
/* 
...
app.get("/", async (req, res) => {
  ...
  const userColor = users.find((user) => user.id === currentUserId).color;
